...
- **`lp-workshop-grc-ti-b-greatpages.html`** — Fragmento da versão curta para o bloco HTML do GreatPages. Gerado com `python3 build_greatpages.py lp-workshop-grc-ti-b`.
